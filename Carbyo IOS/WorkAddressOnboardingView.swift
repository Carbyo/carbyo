//
//  WorkAddressOnboardingView.swift
//  Carbyo IOS
//
...
struct WorkAddressOnboardingView: View {
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    Text("Informations d'adresse professionnelle")
                }
                
                if let existingAddress = onboardingStore.workAddress {
                    Section {
            ...
            .navigationTitle("Adresse professionnelle")
    ...
    private func saveAddress() {
        ...
        onboardingStore.setWorkAddress(address)
        dismiss()
    }
}
